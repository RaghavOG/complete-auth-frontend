...
import TwoFAVerification from '@/pages/TwoFAVerification'; // Import TwoFAVerification component
...
const Login2FA = () => {
  ...
  const [show2FA, setShow2FA] = useState(false); // Add state for 2FA
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (response.data.requires2FA) {
          ...
          // Handle non-2FA login here
          toast.success('Login successful!');
          // Perform login actions (e.g., store user data, redirect)
          navigate("/");
        }
      }
    } catch (error) {
  ...
  return (
    ...
    >
      {!show2FA ? ( // Conditionally render the login form or 2FA verification
